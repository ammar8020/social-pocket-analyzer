...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL14 = "mentionedUserId";
...
//    private static final String COL16 = "Favorited";
    ...
    public boolean addData(String tweet, byte[] image, String _ID, String IDStr, String Name,
        ...
        contentValues.put(COL14, mentionedUserId);


        Log.d(TAG, "addData: Adding " + tweet + " and " + image + " and " + mentionedUserId + " to " + TABLE_NAME);
